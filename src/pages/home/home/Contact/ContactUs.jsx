...
const ContactUs = () => {
  ...
  const handleContact = (event) => {
    ...
    const contactInfo = { yourName, email, companyName, message };
      ...
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="max-w-2xl mx-auto text-center" data-aos="fade-right">
          ...
          <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-white">
            Send us a email if need help with anything. Like if a specific toy
            is available or not? How much does a toy cost? You can also
            pre-order.
          </p>
        </div>
          ...
          <div className="grid items-stretch grid-cols-1 lg:grid-cols-5">
            <div className="lg:col-span-3">
              <div className="p-6 sm:p-10">
                ...
                <form onSubmit={handleContact} method="POST" className="mt-8">
            ...
            <div className="bg-zinc-300 lg:col-span-2">
                    ...
                    <div className="mt-8 space-y-7">
                      <div className="flex items-start">
                        ...
                        <span className="block ml-3 text-base text-gray-900">
                          Satmasjid Road, Dhanmondi 15, Dhaka
                        </span>
                      </div>
